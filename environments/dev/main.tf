...
module "networking" {
  ...
  security_group_name_prefix = "dev-ec2-sg-"
...
module "ec2_instance" {
  ...
  instance_name     = "dev-migration-instance"
  environment      = "dev"
...
locals {
  user_data_script = <<-EOF
              ...
              <body>
                  <div class="container">
                      <h1>🚀 Angular4 Migration App - Development</h1>
                      ...
                      <div class="footer">
                          <p>Angular4 Migration Environment - Development Environment</p>
