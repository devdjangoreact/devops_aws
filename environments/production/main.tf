...
module "networking" {
  ...
  security_group_name_prefix = "production-ec2-sg-"
  security_group_name        = "production-ec2-security-group"
  environment                = "production"
}

# EC2 Instances (Blue-Green Deployment - 2 instances)
module "ec2_instance_primary" {
  source = "../../modules/ec2-instance"

  instance_type     = var.instance_type
  instance_name     = "production-migration-instance-primary"
  environment       = "production"
...
module "ec2_instance_secondary" {
  ...
  instance_type     = var.instance_type
  instance_name     = "production-migration-instance-secondary"
  environment       = "production"
  security_group_id = module.networking.security_group_id
  user_data         = local.user_data_script
}
...
locals {
  user_data_script = <<-EOF
              ...
              <body>
                  <div class="container">
                      <h1>🚀 Angular4 Migration App - Production</h1>
                      ...
                      <div class="footer">
                          <p>Angular4 Migration Environment - Production Environment</p>
