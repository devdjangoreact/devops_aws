...
**Key Findings:**
- **60% cost reduction** from ~$2,500/month to target <$1,000/month
...
### Monthly Cost: $700-900 (Estimated)

| Service Category | Service | Monthly Cost | Details |
|------------------|---------|--------------|---------|
| **Compute** | ECS Fargate | $300 | Pay-per-task pricing |
| | | | - Frontend: 2-8 tasks (avg 3) |
| | | | - Backend: 3-12 tasks (avg 4) |
| | | | - Auto-scaling based on load |
| **Database** | Aurora Serverless v2 | $200 | Auto-scaling ACU (2-8) |
| | | | - Pay for actual usage |
| | | | - No I/O costs |
| **Caching** | ElastiCache Redis | $50 | 1 x cache.t3.micro |
| **Load Balancing** | ALB | $20 | Application Load Balancer |
| **Networking** | VPC Endpoints | $10 | S3, ECR, CloudWatch endpoints |
| | | | - Eliminates NAT Gateway costs |
| **Storage** | EBS (ECS) | $20 | Minimal EBS for ECS tasks |
| **Storage** | S3 Logs | $30 | 30-day retention policy |
| **Monitoring** | CloudWatch | $50 | Enhanced monitoring |
| **Container Registry** | ECR | $20 | Storage for Docker images |
| **Backup** | Automated Backups | $20 | Aurora automated snapshots |
| **Other** | Misc (VPC, etc.) | $24 | VPC, security groups |
...
**Calculation:**
```
Frontend: 3 tasks × 0.5 vCPU × 1 GB × 730 hours × $0.04048/h = $88.70
Backend: 4 tasks × 1 vCPU × 2 GB × 730 hours × $0.04048/h = $236.00
Total Fargate: $324.70/month
```

#### 2. Aurora Serverless v2 Auto-Scaling
- **Before:** $800/month for always-on db.r5.large
- **After:** ~$200/month for auto-scaling ACU
- **Savings:** $600/month (75% reduction)

**ACU Usage Pattern:**
- Business hours (8 hours): 6-8 ACU
- Off hours (16 hours): 2 ACU
- Average: 4.67 ACU × 730 hours × $0.0434/h ≈ $186/month

#### 3. Optimized Log Retention
- **Before:** $150/month (unlimited retention)
- **After:** $30/month (30-day retention)
- **Savings:** $120/month

**Storage Calculation:**
- Daily logs: ~50GB
- 30-day retention: 1.5TB
- Cost: $0.023/GB/month × 1500GB = $34.50

#### 4. NAT Gateway Elimination
- **Before:** $36/month always-on
- **After:** $10/month VPC endpoints
- **Savings:** $26/month
...
|-----------|--------------|----------|---------|-------------|
| Compute (EC2/Fargate) | $1,200 | $300 | $900 | 75% |
| Database (Aurora) | $800 | $200 | $600 | 75% |
| Storage (Logs) | $150 | $30 | $120 | 80% |
| Networking (NAT) | $36 | $10 | $26 | 72% |
| EBS Storage | $120 | $20 | $100 | 83% |
| ECR Storage | $0 | $20 | -$20 | New cost |
| **Total** | **$2,500** | **$700** | **$1,800** | **72%** |
...
- **Break-even Period:** 14,000 ÷ 1,800 ≈ 8 months
- **Annual Savings:** $21,600
- **3-Year Savings:** $64,800
...
4. **Months 6-8:** Cost optimization and break-even
...
The migration from EC2-based to serverless architecture delivers substantial cost savings while improving operational efficiency. The 72% cost reduction ($1,800/month savings) provides strong ROI with break-even achieved in approximately 8 months.
